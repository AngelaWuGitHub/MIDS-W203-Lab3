...
In the model 1 , we can represent true 
 ...
 $$\beta_0, \beta_1,\beta_2$$  is the interceipts and coefficients of A (prbarr) and B (prbconv) respectively.  We can represent the Population regression as 
