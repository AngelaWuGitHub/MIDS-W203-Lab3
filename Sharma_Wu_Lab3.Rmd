...
The scatter plot of prbpris vs. crmrte doesn't show an obvious relationship.
The correlation coefficient is only 0.05.
```{r}
...
The scatter plot of avgsen vs. crmrte doesn't show an obvious relationship.
The correlation coefficient is only 0.01.
```{r}
