...
All the parameter estimates are pratically significant. 
...
```{r}
model3 <- lm(crmrte_log ~ prbarr+prbconv+prbpris+avgsen+polpc_log+density_log+taxpc+west+central+mix+pctymle, data=crimeData2)
